...
if ($('.js-tab-btn').length) {
    ...
    $c.click(function(){
        ...
        $('.thumb').lazyload({
            data_attribute: 'src',
            placeholder: '/static/img/a787ff0dgy1fjhwuj9ptag20010010sh.gif',
            threshold: 130
        });
    });
...
*/
$(function(){
    if(window.location.href.indexOf("paly")>-1){
        return;
    }
...
$(".sitenav").children().each(function () {
    if (window.location.pathname.indexOf($(this).attr("href")) != -1 && ($(this).attr("href") != "/" || $(this).attr("href") == window.location.pathname)) {
        $(this).attr("class", "cur");
    }
});
$("#searchButton").click(function () {
    window.location.href="/s/"+$("#wd").val();
});
