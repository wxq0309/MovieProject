...
var MAC={
    ...
    'Login':{
        ...
        'Info':function(){
            $.ajax({type:'get',url: '/index.php?m=user-ajaxinfo',dataType:'json',timeout: 5000,
                error: function(){
                    alert('登录失败');
                },
                success: function($r){
        ...
        'Create':function($id){
            ...
            if(MAC.Cookie.Get('userid')!=undefined && MAC.Cookie.Get('userid')!=''){
                html+='<ul class="logged"><li><a target="_blank" href="/index.php?m=user-index">我的资料</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.Login.Out(\''+$id+'\');" target="_self"><i class="ui-icon user-logout"></i>退出</a></li></ul>';
            }
            else{
                html+='<form id="loginform" onsubmit="return false;" action="/index.php?user-check" method="post"><div class="formitem"><label>用户：</label><input name="username" type="text"  class="input" id="username"/></div><div class="formitem"><label>密码：</label><input name="userpass" type="password" class="input" id="userpass"/></div><div class="formitem"><a class="qq-login" href="/index.php?m=user-reg-ref-qqlogin.html"></a> <input class="formbutton" id="loginbtn" type="submit" value="登 录"></div><div class="formitem"><a title="忘记密码" class="forgotpass" href="/index.php?m=user-findpass.html">忘记密码?</a>  <a class="reg-btn" href="/index.php?m=user-reg.html" target="_blank">还没有账号?</a></div></form>';
            }
        ...
        'Out':function($id){
            $.ajax({type:'get',url: '/index.php?m=user-logout',timeout: 5000,
                success: function($r){
        ...
        'In':function(){
            ...
            $.ajax({type: 'post',url: '/index.php?m=user-check', data:'u_name='+$("#username").val()+'&u_password='+$("#userpass").val(),timeout: 5000,
                error: function(){
                    alert('登录失败');
                },
                success: function($r){
    ...
    'Score': {
        'ajaxurl': 'http://m.52xmw.com/template/xmys/i/js/inc/ajax.php?ac=score',
