...
access_key_id = os.getenv('OSS_TEST_ACCESS_KEY_ID', 'LTAIatq91508QOPV')
access_key_secret = os.getenv('OSS_TEST_ACCESS_KEY_SECRET', 'rp9vIYNTnZskVIBRevq7nNPhpMYh8o')
bucket_name = os.getenv('OSS_TEST_BUCKET', 'person-movie')
endpoint = os.getenv('OSS_TEST_ENDPOINT', 'www.hjx.pub')
